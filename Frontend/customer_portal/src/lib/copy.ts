...
export const copy = {
  ...
  help: {
    ...
    topics: [
      { title: "Getting started", body: "What the portal does and how the assistant works.", icon: "compass" },
      {
        title: "Talking to the assistant",
        body: "Start a conversation, mute, and what the assistant can do for you.",
        icon: "audio-lines",
      },
      { title: "Billing and invoices", body: "Invoices, balances, and what a charge means.", icon: "receipt-text" },
      { title: "Plans and add-ons", body: "What you have with us today and how it renews.", icon: "layers-2" },
      { title: "Privacy and data", body: "What is recorded, and what happens to it.", icon: "shield" },
      { title: "Accessibility", body: "Screen readers, keyboard use, and reduced motion.", icon: "accessibility" },
    ],
  },
  profile: {
    nav: {
