...
caller context, installs PII-masked logging, and starts the worker. No business logic here.
"""
...
async def _prefetch_user_data(language: str) -> SessionUserData:
    ...
    if msisdn:
        ...
        if snapshot is not None:
            ...
            # PII-safe: log the non-PII customer_id, never the name/MSISDN (review note 5a).
