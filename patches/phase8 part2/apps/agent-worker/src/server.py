...
caller context, installs PII-masked logging, and starts the worker. Sentiment now runs per-turn
inside BaseTelecomAgent, so no session-level sentiment hook is wired here.
"""
